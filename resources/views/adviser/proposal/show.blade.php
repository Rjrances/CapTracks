            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('adviser.proposal.comments.store', $proposal->id) }}" method="POST" class="mb-4">
                                @csrf
                                <label for="adviser-comment-body" class="form-label">Add comment</label>
                                <textarea
                                    id="adviser-comment-body"
                                    name="body"
                                ...
                                <div class="d-flex flex-column gap-3">
                                    @foreach($comments as $comment)
                                        <div class="border rounded p-3 bg-white">
                                            ...
                                            <button class="btn btn-sm btn-outline-secondary mb-2" type="button" data-bs-toggle="collapse" data-bs-target="#adviser-reply-{{ $comment->id }}">
                                                Reply
                                            </button>

                                            <div class="collapse" id="adviser-reply-{{ $comment->id }}">
                                                <form action="{{ route('adviser.proposal.comments.store', $proposal->id) }}" method="POST" class="mb-3">
                                                    @csrf
