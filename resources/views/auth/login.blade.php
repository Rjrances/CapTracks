        ...
        <div class="w-full max-w-md">
            ...
            <form method="POST" action="/login" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="password" name="password" id="password" required class="w-full p-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" autocomplete="current-password" />
                </div>
            ...
            <p class="mt-6 text-center text-sm text-gray-600">
                First time here?
                <a href="{{ route('login.student-credentials') }}" class="text-blue-600 font-medium hover:underline">Email me a temporary password</a>
            </p>
        </div>
    </div>
</body>
