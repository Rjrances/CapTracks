                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('chairperson.teachers.update', $teacher->faculty_id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="mb-3">
                                    <label for="name_prefix" class="form-label fw-bold">Prefix</label>
                                    <input type="text" 
                                           name="name_prefix" 
                                           id="name_prefix" 
                                           class="form-control @error('name_prefix') is-invalid @enderror" 
                                           value="{{ old('name_prefix', $teacher->name_prefix) }}" 
                                           placeholder="Dr.">
                                    @error('name_prefix')
                            ...
                            <div class="col-md-2">
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           value="{{ old('suffix', $teacher->suffix) }}" 
                                           placeholder="Jr., III">
                                    @error('suffix')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="fw-bold mb-0">{{ $teacher->formatted_name }} ({{ $teacher->faculty_id }})</p>
            </div>
