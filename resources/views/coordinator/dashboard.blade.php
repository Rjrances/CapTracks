...
<div class="p-6 max-w-6xl mx-auto">
    <h1 class="text-3xl font-bold mb-2">Coordinator Dashboard</h1>
    <p class="text-gray-600 mb-6">Manage schedules, assignments, and communications</p>

    {{-- Quick Actions --}}
    <div class="flex gap-4 mb-6">
        <a href="{{ route('classes.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700">Create New Class</a>
        <a href="{{ route('classes.index') }}" class="bg-gray-200 px-4 py-2 rounded hover:bg-gray-300">View All Classes</a>
    </div>
        ...
        <div class="overflow-x-auto bg-white shadow rounded">
            <table class="min-w-full text-left">
                ...
                <tbody>
                    ...
                    @if($events->isEmpty())
                    <tr>
                        <td colspan="4" class="text-center px-6 py-4 text-gray-500">No upcoming events.</td>
                    </tr>
                    @endif
                </tbody>
            </table>
