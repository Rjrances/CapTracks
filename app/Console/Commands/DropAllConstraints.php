...
class DropAllConstraints extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'drop:all-constraints';
     ...
     * @var string
     */
    protected $description = 'Drop all foreign key constraints';
    ...
    {
        $this->info('Dropping all foreign key constraints...');
