...
{
    /**
     * Display a listing of proposals for review
     */
    public function index()
    {
        $user = Auth::user();
        
        // Get groups where this user is the adviser
    ...
    /**
     * Display the specified proposal for review
     */
    public function show($id)
    {
        ...
        // Check if user is the adviser for this student's group
    ...
    /**
     * Show the form for editing/reviewing the proposal
     */
    ...
    /**
     * Update the proposal status and provide feedback
     */
