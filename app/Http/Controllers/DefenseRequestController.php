...
{
    /**
     * Display a listing of defense requests
     */
    ...
    /**
     * Show the form for creating a defense schedule
     */
    public function createSchedule(DefenseRequest $defenseRequest)
    {
        // Check if defense request is pending
    ...
    /**
     * Store a newly created defense schedule
     */
    public function storeSchedule(Request $request, DefenseRequest $defenseRequest)
    {
        ...
        try {
            ...
            // Create defense panel assignments
            ...
            // Send notifications to faculty panelists
    ...
    /**
     * Show the form for editing a defense schedule
     */
    ...
    /**
     * Update the specified defense schedule
     */
