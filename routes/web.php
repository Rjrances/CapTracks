...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['auth', 'role:coordinator|adviser'])->prefix('coordinator')->name('coordinator.')->group(function () {
        ...
        Route::patch('milestones/{milestone}/tasks-order', [MilestoneTemplateController::class, 'updateTasksOrder'])->name('milestones.tasks.order');
...
Route::prefix('student')->name('student.')->middleware([\App\Http\Middleware\StudentAuthMiddleware::class, \App\Http\Middleware\CheckStudentPasswordChange::class])->group(function () {
    ...
    Route::delete('/group/cancel-adviser-invitation/{invitation}', [StudentGroupController::class, 'cancelAdviserInvitation'])->name('group.cancel-adviser-invitation');
    ...
    Route::post('/milestones/{milestone}/tasks', [StudentMilestoneController::class, 'storeTask'])->name('milestones.store-task');
